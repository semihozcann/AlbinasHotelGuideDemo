...
namespace albinasHotelGuide.Business.Configuration
{
    public class ConfigureRepositories
    {
        public static void AddService(IServiceCollection services, IConfiguration configuration)
        {
            ...
            }).AddEntityFrameworkStores<AlbinasHotelGuideContext>();
            ...
            services.ConfigureApplicationCookie(option =>
            {
                ...
                option.Cookie.Name = "AlbinasHotelGuide";
            ...
            services.AddScoped<DbContext, AlbinasHotelGuideContext>();
